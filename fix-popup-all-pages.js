...
const projects = {
  ...
  'portfolio-single-habitline.html': {
    ...
    popupAccent: '#93401F',
    eyebrow: 'Case Study',
    title: 'Habitline Framer Template',
    subtitle: 'Framer · Template · SaaS',
    summary: 'High-Converting Mobile App Landing Page Template for SaaS, AI Tools, and Productivity Apps. This template is designed for modern mobile and web applications that need a clear, high converting landing page.',
    highlights: [
      'Conversion optimized sections with clear call to action blocks',
      'Fully responsive and mobile-ready layouts',
      'SEO friendly structure with optimized headings',
      'Lightning-fast load times for better rankings',
      'Subtle animations enhance interaction without overwhelming the experience',
    ],
    liveUrl: '#',
  },
};
